...
objects = {
	...
	"(134340) Pluto|9": {"tags": ["solar_system", "minor_body", "tno", "plutino"],
		"filters": "Landolt", "indices": {"B-V": 0.867, "V-R": 0.515, "R-I": 0.400}, "sun": True
	},
    ...
    "HD 189733 b|10": {"nm": [358.9, 437.2, 549.3, 1000], "br": [0.62, 0.61, 0.28, 0.09], "albedo": True}
}
