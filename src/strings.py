...
names = {
    ...
    'Ice at Phoenix landing site': {'ru': 'Лёд на месте посадки Phoenix', 'de': 'Ice at Phoenix landing site'},
    'Soil at Phoenix landing site': {'ru': 'Грунт на месте посадки Phoenix', 'de': 'Eis am Phoenix-Landeplatz'},
    'Phobos': {'ru': 'Фобос'},
    'Deimos': {'ru': 'Деймос'},
    # Jovian system
    'Jupiter': {'ru': 'Юпитер'},
    ...
    # Deep sky objects
    'Galaxy bulges': {'ru': 'Ядра галактик', 'de': 'Galaxienkern'},
...
notes = {
    ...
    'Inner coma': {'ru': 'Внутренная кома', 'de': 'Inneres Koma'},
    'Outer coma': {'ru': 'Внешнаяя кома', 'de': 'Äußeres Koma'},
    ...
    'Porous grains model': {'ru': 'Модель полых зёрен', 'de': 'Modell der porösen Körner'},
    'Compact grains model': {'ru': 'Модель компактных зёрен', 'de': 'Kompaktes Körnermodell'},
