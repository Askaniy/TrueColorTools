...
names = {
    ...
    'Canis Majoris': {'ru': 'Большого Пса'},
    'Canis Minoris': {'ru': 'Малого Пса'},
    #'Capricorni': {'ru': ''},
    #'Carinae': {'ru': ''},
    #'Cassiopeiae': {'ru': ''},
    ...
    'Wezen': {'ru': 'Везен'},
    'Yildun': {'ru': 'Йильдун'},
    'YZ Canis Minoris with flare IF3': {'ru': 'YZ Малого Пса со вспышкой IF3', 'de': 'YZ Canis Minoris mit Flare IF3'},
    'Flare IF3 of YZ Canis Minoris': {'ru': 'Вспышка IF3 на YZ Малого Пса', 'de': 'Flare IF3 von YZ Canis Minoris'},
    # Star types
    ...
    'D/Shoemaker–Levy 9 impact site': {'ru': 'След от столкновения Шумейкеров—Леви 9', 'de': 'D/Shoemaker–Levy 9-Einschlagmal'},
    'Wesley impact scar': {'ru': 'След от столкновения Уэсли', 'de': 'Wesley-Einschlagmal'},
    'Aurorae of Jupiter': {'ru': 'Полярные сияния Юпитера', 'de': 'Jupiterauroren'},
    ...
    'Aurorae of Io': {'ru': 'Полярные сияния Ио', 'de': 'Ioauroren'},
    'Aurorae of Europa': {'ru': 'Полярные сияния Европы', 'de': 'Europaauroren'},
    'Aurorae of Ganymede': {'ru': 'Полярные сияния Ганимеда', 'de': 'Ganymedauroren'},
    'Aurorae of Callisto': {'ru': 'Полярные сияния Каллисто', 'de': 'Kallistoauroren'},
    # Jovian irregulars
    'Himalia': {'ru': 'Гималия'},
    'Elara': {'ru': 'Элара'},
    'Pasiphae': {'ru': 'Пасифе'},
    ...
    # Saturnian system
    'Saturn': {'ru': 'Сатурн'},
    'Aurorae of Saturn': {'ru': 'Полярные сияния Сатурна', 'de': 'Saturnauroren'},
    ...
    'ν ring': {'ru': 'Кольцо ν', 'de': 'ν-Ring'},
    'μ ring': {'ru': 'Кольцо μ', 'de': 'μ-Ring'},
    'Portia': {'ru': 'Порция'},
    ...
    'Standard AGN': {'ru': 'Стандартное АЯГ', 'de': 'Standard-AGN'},
    'AGN': {'ru': 'АЯГ', 'de': 'AGN'},
    'Galaxy bulges': {'ru': 'Балджи галактик', 'de': 'Galaxienbulge'},
    ...
    'Irregular galaxies': {'ru': 'Неправильные галактики', 'de': 'Irreguläre Galaxien'},
...
notes = {
    ...
    'White material': {'ru': 'Белый материал', 'de': 'Weißes Material'},
    'Yellow material': {'ru': 'Жёлтый материал', 'de': 'Gelbes Material'},
    'Red material': {'ru': 'Красный материал', 'de': 'Rotes Material'},
    ...
    '25% of maximum cross-section': {'ru': '25% макс. попереч. сечения', 'de': '25% des maximalen Querschnitts'},
    ...
    # - Surface orientation / spatial sectors
    ...
    # - Jupiter
    'Fragment-E': {'ru': 'Фрагмент-E'},
    # - Minor body categories
    ...
    # - Surface types
    'Amorphous water ice': {'ru': 'Аморфный водяной лёд', 'de': 'Amorphes Wassereis'},
    'Crystallized water ice': {'ru': 'Кристаллизованный водяной лёд', 'de': 'Kristallisiertes Wassereis'},
    ...
    'Nitrogen type': {'ru': 'Азотный тип', 'de': 'WN-Typ'},
    'Carbon type': {'ru': 'Углеродный тип', 'de': 'WC-Typ'},
    # - Deep sky
    'Starting point is SED by Richards et al. 2006': {'ru': 'На основе SED от Richards et al. 2006', 'de': 'Ausgangspunkt ist SED von Richards et al. 2006'},
